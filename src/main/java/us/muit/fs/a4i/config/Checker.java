...
/**
 * Mantengo separada la lógica de la gestión de configuración de métricas e indicadores porque en el futuro van a ser bastante diferentes
 * En la versión actual son muy similares y por tanto el diseño no es bueno ya que no identifica bien la reutilización
 * @author isa
 *
 */
