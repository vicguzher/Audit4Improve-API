...
public class ReportItem<T> implements ReportItemI<T>{
	 ...
	 * SÃ³lo lo utiliza el propio constructor, es privado, nadie, que no sea el constructor, puede crear una ReportItem
	...
	/**
	 * Obtiene la descripciÃ³n del ReportItem
	 * @return DescripciÃ³n del significado del ReportItem
	 */
	...
	/***
	 * Establece la fuente de la informaciÃ³n para el ReportItem
	 * @param source fuente de informaciÃ³n origen
	 */
	...
	public static class ReportItemBuilder<T>{
		...
		/**
		 * <p>Establece la descripciÃ³n del ReportItem</p>
		 * @param description Breve descripciÃ³n del significado del ReportItem
